---
title: "Errorlocate"
subtitle: "Find and replace erroneous fields in data using validation rules" 
...
- give a clear overview what the data should conform to
- can be used to reason about
- can be used to fix/correct data!
- Find error, and when found try to correct.
...
- translates errorlocation problem into a **mixed integer problem**, which
